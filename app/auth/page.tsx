    ...
    <AuthShell title="Sign in" subtitle="Enter your staff credentials.">
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="space-y-1">
          ...
          <div className="mt-1 relative rounded-md shadow-sm">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gray-600 focus:outline-none cursor-pointer"
            >
              {showPassword ? (
                // Eye Off Icon
        ...
        <button
          ...
          className="w-full flex justify-center rounded-md bg-[#00a651] px-4 py-3 text-sm font-bold text-white shadow-sm hover:bg-[#048f47] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#00a651] disabled:cursor-not-allowed disabled:opacity-70"
        >
