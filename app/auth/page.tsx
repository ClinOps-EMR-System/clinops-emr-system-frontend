    ...
    <AuthShell title="Sign in" subtitle="Enter your staff credentials.">
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full flex justify-center rounded-md bg-clinical-primary px-4 py-3 text-sm font-bold text-white shadow-sm hover:bg-clinical-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-clinical-primary disabled:cursor-not-allowed disabled:opacity-70"
        >
