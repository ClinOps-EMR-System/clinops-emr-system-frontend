  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 font-sans">
      ...
      <section className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
          <span className="text-xs font-bold text-brand-teal tracking-widest uppercase">Patient Management</span>
        ...
        <div className="flex gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-bold rounded bg-[#368D80] text-white hover:bg-[#2A7066] shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#368D80] cursor-pointer"
          >
            Consultation (SOAP)
          </Link>
          <button
