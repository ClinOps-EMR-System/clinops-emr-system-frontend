      ...
      className={composeRenderProps(
        ...
        (className, { isFocusVisible, isPressed, isHovered, isDisabled }) =>
          twMerge(
            ...
            isCurrent &&
              "font-medium bg-(--sidebar-current-bg)/10 text-(--sidebar-current-fg) hover:bg-(--sidebar-current-bg)/15 hover:text-(--sidebar-current-fg) [&_.text-muted-fg]:text-fg/80 [&_svg:not([class*='text-'])]:text-(--sidebar-current-fg) hover:[&_svg:not([class*='text-'])]:text-(--sidebar-current-fg)",
...
interface SidebarLinkProps extends React.ComponentProps<'div'> {
