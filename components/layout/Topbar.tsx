  ...
  return (
    <header className="h-16 bg-sidebar flex items-center gap-4 px-4 md:px-6 border-b border-sidebar-border z-10 font-sans">
      ...
      <button
        ...
        className="lg:hidden p-2 -ml-2 text-sidebar-foreground hover:text-sidebar-foreground hover:bg-sidebar-accent rounded-md transition-colors"
      ...
      <nav aria-label="Breadcrumb" className="hidden lg:flex items-center shrink-0">
        <ol className="flex items-center gap-1.5 text-xs font-medium">
          <li className="inline-flex items-center">
            <Link href="/dashboard" className="text-sidebar-foreground hover:underline transition-colors inline-flex items-center min-h-0 min-w-0 h-auto py-0">
              Home
            </Link>
          </li>
            ...
            if (!isLast && idx < breadcrumbs.length - 1) {
              return (
                <li key={idx} className="inline-flex items-center gap-1.5">
                  ...
                  <Link href={crumb.href} className="text-sidebar-foreground hover:underline transition-colors inline-flex items-center min-h-0 min-w-0 h-auto py-0">
                    {crumb.label}
                  </Link>
                </li>
              );
